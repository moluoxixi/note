...
1. 正文（主体） - 描述要呈现的核心对象、人物、动物或场景

2. 背景环境 - 设定场景的具体环境和氛围

3. 动作描述 - 明确主体正在执行的具体动作

4. 镜头设置 - 定义相机的位置、角度和运动方式

### 2. 风格与视觉效果

1. 创意风格 - 指定电影风格（科幻、恐怖、黑色电影）或动画风格（卡通）

2. 相机定位 - 航拍、平视、俯拍、轨道拍摄、仰拍等视角控制

3. 构图方式 - 广角镜头、特写镜头、单人镜头、双人镜头等构图选择

4. 对焦效果 - 浅景深、深景深、柔焦、微距镜头、广角镜头等视觉效果

5. 氛围营造 - 蓝色调、夜间、暖色调等颜色和光线描述

### 3. 多镜头叙事结构

1. 连贯叙事 - 镜头1 + 主体 + 动作1 + 镜头2 + 主体 + 动作2...

2. 时序动作 - 主体1 + 运动1 + 运动2（连续动作序列）

3. 多主体协调 - 主体1 + 运动1 + 主体2 + 运动2...（多角色同时行动）

### 4. 运镜技巧词汇

1. 镜头切换 - "镜头切换"实现场景转换

2. 镜头平移 - "镜头向上/下/左/右移动"控制视角移动

3. 推轨效果 - "镜头拉近/拉远"调整景深距离

4. 环形跟踪 - "镜头环绕"、"航拍"、"广角"、"镜头360度旋转"

5. 跟随拍摄 - "镜头跟随"保持主体在画面中心

6. 固定镜头 - "固定镜头"、"镜头静止不动"营造稳定感

7. 聚焦特写 - "镜头特写"突出重要细节

8. 手持效果 - "镜头晃动/抖动"、"手持拍摄"、"动态不稳定"增加真实感

### 5. 程度副词强化

1. 动作强度 - "快速"、"大幅度"、"高频率"、"剧烈"、"缓缓"

2. 频率描述 - 通过程度副词突出主体动作的频率与强度

3. 特征突出 - 使用形容词和副词为Veo描绘清晰画面

### 6. 面部与细节优化

1. 面部细节 - 指定面部细节作为焦点，使用"portrait"（人像）关键词

2. 描述性语言 - 运用丰富的形容词和副词提升画面表现力

### 7. 完整提示词模板

基础结构： [主体描述] + [背景环境] + [镜头设置] + [动作描述] + [风格定义] + [运镜技巧] + [程度副词] + [氛围营造]

示例： "一只金毛小狗（主体）在阳光明媚的公园草地上（背景）快速奔跑（动作+程度），镜头跟随拍摄（运镜），温暖的金色调（氛围），卡通风格（风格），特写小狗欢快的表情（细节聚焦）"
```
## APIKeys
```
