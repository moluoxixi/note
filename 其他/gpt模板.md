...
```
仔细阅读packages/components中的ExportExcel源码，特别是props,slots,defineExpose,defineEmit，去更新.docs/examples/ExportExcel中对应组件的示例，和.docs/components/基础组件/ExportExcel.md中的文档，参考.docs/examples/DateRangePicker中示例，  
...
## 左侧组件面板
- 使用el-ExportExcel进行组件类型切换，默认展示"全部"
