...
webGL->Three.js->openlayers->cesium
...
1. 将任务队列中的任务推入主线程中 解析代码产生上下文

1. 遇到宏任务推入宏任务队列，遇到微任务推入微任务队列，

1. 遇到函数调用推入执行上下文栈，

1. 遍历执行上下文，轮询3，4两步，直到执行上下文栈清空，

1. 遍历微任务队列，轮询2，3，4，5步，直到微任务队列清空，

1. 执行GUI线程

1. 从宏任务队列中提取一个回调，轮询2，3，4，5，直到宏任务队列清空，

1. 轮询6，7，8三步，直到执行上下文栈，宏任务队列，微任务队列，GUI线程都被清空
