...
| 配置项                                                             | 类型                                | 描述                                                     | 示例       |          |         |     |
| --------------------------------------------------------------- | --------------------------------- | ------------------------------------------------------ | -------- | -------- | ------- | --- |
| [snap](https://x6.antv.antgroup.com/api/model/interaction#snap) | boolean\|\|string                 | 是否开启自动吸附,<br>触发吸附距离 50px。<br><br>可通过配置 radius 自定义吸附半径。 |          | ,        | snap: { |     |
| allowBlank                                                      | boolean\|\|(Graph, args)=>boolean |                                                        |          | 是否允许指向画板 |         |     |
...
| validateEdge                                                    | (Graph,args)=>boolean             | 当停止拖动边时                                                |          |          |         |     |
