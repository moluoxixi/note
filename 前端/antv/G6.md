...
| modes                      | 使用哪些模式,每个模式应用哪些行为                  | Object  | modes: {<br>  //'drag-canvas/combo/node', //画布/combo/节点可拖拽<br>  //'activate-relations', //高亮相同节点<br>  //'click-select' //点击选中节点<br>  //'create-edge' //创建边<br>  default: `['drag-node']`, //节点可拖拽<br>}, |
