...
//vite下 直接获取components  
// 如果直接import.meta.glob("../wlComponents/**/*.vue")获取结构为:  
  // const modulesFiles = {  //   './src/foo.vue': () => import('./src/foo.vue'),  //   './src/bar.vue': () => import('./src/bar.vue')  // }// 根据官方文档说明，import.meta.glob方式匹配到的文件默认是懒加载的，通过动态导入实现，并会在构建时分离为独立的chunk。  
