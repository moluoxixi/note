...
| head        | 配置当前页面的head标签内容,使用[vue-meta库](https://github.com/nuxt/vue-meta)<br><br>**支持this**                                                                                                                                                                                                                                    | head(){<br>  return {<br>    title: '你好',<br>    meta:[],<br>    ...<br>  }<br>}![](assets/Pasted%20image%2020240718161443.png)      |
