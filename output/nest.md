...
![](assets/WEBRESOURCEaf83f0c5078f93bfb16a045e820f8112image.png)
...
![](assets/WEBRESOURCE049afb2f7c364ad46edd9695dd9ec18fimage.png)
...
![](assets/WEBRESOURCEedeb62e4168d112966c85bf61160a53dimage.png)
...
![](assets/WEBRESOURCE2ac1f463361c0b9eb44cbf650c3b3d9cimage.png)

![](assets/WEBRESOURCEc0d36f9c577d4b27c83eecb4cdef0eb4image.png)
...
![](assets/WEBRESOURCE0adfda35602b70dc8fceda8e6d998d2estickPicture.png)

## Session

通过 @Session 拿到 session 对象：

![](assets/WEBRESOURCE304ed3900d0fe8f709361041ca2d8301stickPicture.png)

但要使用 session 需要安装一个 express 中间件：npm install express-session

在 main.ts 里引入并启用：

![](assets/WEBRESOURCE4405e2e9c870e5c081f8860fe889459dstickPicture.png)
...
![](assets/WEBRESOURCE6b9a938c16f87821af2988654ed179ccstickPicture.png)
...
![](assets/WEBRESOURCE2783507738343fae183f05569b13e8e7stickPicture.png)

## SetMetadata

handler 和 class 可以通过 @SetMetadata 指定 metadata：

![](assets/WEBRESOURCE35aaa0407b950fb3f72b8fef128455f1stickPicture.png)

然后在 guard 或者 interceptor 里取出来：

![](assets/WEBRESOURCE2fae8c680564f0d43ce734ac93dda11fstickPicture.png)

## Render

返回的响应内容指定渲染引擎，不过这需要先这样设置：

![](assets/WEBRESOURCE009fcc8434f9fed5f286a81fa0405213image.png)
...
![](assets/WEBRESOURCEdc66812ea3d7b2b842210c081334a227stickPicture.png)

![](assets/WEBRESOURCE7c9e8aa72cceddcb920179eae3e755f2stickPicture.png)

在 handler 里指定模版和数据：

![](assets/WEBRESOURCE47107bc83f46d3caa3ed19b4b1e1c133stickPicture.png)

就可以看到渲染出的 html 了：

![](assets/WEBRESOURCEdf7fc63446dc065570e9019e09fa32cdstickPicture.png)
...
![](assets/WEBRESOURCEe120cbb78870435a46da0f141a4a2544%E6%88%AA%E5%9B%BE.png)
...
![](assets/WEBRESOURCE9cc262a35f70485d8d6dbad772566824image.png)
...
![](assets/WEBRESOURCE05429cc421f8b6d669ed63e8e2a73358image.png)
