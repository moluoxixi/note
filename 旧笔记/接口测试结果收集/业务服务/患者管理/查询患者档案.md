...
```
# 业务服务/患者管理 - 查询患者档案 - 必填校验-[orgCode]为空
## 请求参数：
``` json
{
  "pageSize": 3,
...
```
# 业务服务/患者管理 - 查询患者档案 - 必填校验-[pageIndex]为空
## 请求参数：
``` json
{
  "pageSize": 3,
...
```
# 业务服务/患者管理 - 查询患者档案 - 必填校验-[pageSize]为空
## 请求参数：
``` json
{
  "pageSize": null,
...
```
# 业务服务/患者管理 - 查询患者档案 - 类型校验-[pageIndex]类型错误
## 请求参数：
``` json
{
  "pageSize": 3,
...
```
# 业务服务/患者管理 - 查询患者档案 - 类型校验-[pageSize]类型错误
## 请求参数：
``` json
{
  "pageSize": "abc",
...
```
# 业务服务/患者管理 - 查询患者档案 - 依赖用例-[orgCode]赋值为依赖用例测试值
## 请求参数：
``` json
{
  "pageSize": 3,
