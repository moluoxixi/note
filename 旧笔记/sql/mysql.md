...
|正则运算符REGEXP|SELECT job_id  FROM jobs WHERE job_id REGEXP 'IT.*';|返回所有`job_id`字段值以"IT"开头的记录|
...
<img src="E:/需同步/我的坚果云/mysql/MySQL基础篇.assets/image-20220613135809104.png" alt="image-20220613135809104" style="zoom:80%;" />
...
![image-20220613202507072.png](eb5cce42f72734a57b665eb1fa68e44b.png)
...
![image-20220613210116486.png](6264bcc73949e6bc3c1a350bdd48b487.png)
